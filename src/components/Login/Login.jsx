  ...
  return (
    ...
    <div className='flex justify-center items-center h-full bg-blend-overlay'>
        <form action="" className='max-w-[400px] w-full mx-auto bg-white p-8 text-black rounded-3xl'>
            ...
            <p className='relative top-3 left-16'>New Member?<button className='w-full left-2 bottom-6 relative text-indigo-600' onClick={()=>navigate('/register')}>Sign Up</button></p>
